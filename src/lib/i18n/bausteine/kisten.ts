...
export const kisten: Woerterbuch = {
  ...
  'kisten.filter_oeffnen': { de: 'Filter öffnen', ar: 'فتح التصفية' },
  'kisten.filter_schliessen': { de: 'Filter schließen', ar: 'إغلاق التصفية' },
  'kisten.filter_zuruecksetzen': { de: 'Filter zurücksetzen', ar: 'إلغاء التصفية' },
  ...
  'kisten.sort_groesste': { de: 'Größte zuerst', ar: 'الأكبر أولاً' },
  ...
  'kisten.leer_filter': {
    de: 'Zu diesem Filter passt gerade nichts. Setz den Filter zurück.',
  ...
  // ------------------------------------------------------------ Groesse
  'kisten.groesse_knopf': { de: 'Größe {n}, {wort}', ar: 'الحجم {n}، {wort}' },
  ...
  'kisten.kuerzel_frage': { de: 'Welches Kürzel steht vorne?', ar: 'أي رمز يأتي في البداية؟' },
  'kisten.kuerzel_hinweis': {
    de: 'Eine Kiste kann zu einem Zimmer und einer Person gehören. Die Nummer beginnt aber mit genau einem Kürzel.',
  ...
  'kisten.titel_hinweis': {
    de: 'Optional, zum Beispiel Bücher Regal links.',
  ...
  'kisten.fehler_kein_tag': {
    de: 'Wähle mindestens ein Zimmer oder eine Person.',
  ...
  'kisten.loeschen': { de: 'Kiste löschen', ar: 'حذف الصندوق' },
  'kisten.art_und_groesse': {
    de: '{art}, Größe {n} von 10, {wort}',
  ...
  'kisten.ohne_zuordnung_hinweis': {
    de: 'Beides lässt sich beim Bearbeiten setzen.',
  ...
  'kisten.kopieren_fehler': { de: 'Kopieren nicht möglich: {grund}', ar: 'تعذّر النسخ: {grund}' },
  ...
  'kisten.eintrag_loeschen': { de: 'Eintrag löschen', ar: 'حذف الإدخال' },
  'kisten.eintrag_hinzufuegen': { de: 'Eintrag hinzufügen', ar: 'إضافة إدخال' },
  ...
  'kisten.foto_loeschen': { de: 'Foto löschen', ar: 'حذف الصورة' },
  'kisten.fotos_leer': { de: 'Noch kein Foto vom Inhalt', ar: 'لا توجد صورة للمحتويات بعد' },
  'kisten.fotos_hinweis': {
    de: 'Bilder lassen sich hierher ziehen oder mit Strg und V einfügen.',
  ...
  'kisten.fotos_fehlen.eins': {
    de: 'Ein Foto lässt sich gerade nicht laden.',
  ...
  'kisten.fotos_hinzugefuegt.eins': { de: 'Ein Foto hinzugefügt', ar: 'تمت إضافة صورة' },
  'kisten.fotos_hinzugefuegt.viele': { de: '{n} Fotos hinzugefügt', ar: 'تمت إضافة {n} صور' },
  'kisten.kein_bild.eins': {
    de: 'Eine Datei war kein Bild und wurde übersprungen',
    ar: 'ملف واحد لم يكن صورة، فتم تخطيه',
  },
  'kisten.kein_bild.viele': {
    de: '{n} Dateien waren kein Bild und wurden übersprungen',
  ...
  'kisten.ev_code': { de: 'hat den Code geändert:', ar: 'غيّر الرقم:' },

  // --------------------------------------------------- Bearbeiten und Loeschen
  'kisten.code_hinweis': {
    de: 'Änderst du Größe oder Kürzel, vergibt Kistly einen neuen Code. Der alte bleibt gespeichert, damit ein schon geklebtes Etikett weiter gefunden wird.',
    ar: 'إذا غيّرت الحجم أو الرمز، يعطي Kistly رقمًا جديدًا. يبقى القديم محفوظًا حتى يظل الملصق الملصوق قابلاً للعثور عليه.',
  },
  'kisten.kuerzel_im_code': { de: 'Kürzel im Code', ar: 'الرمز في رقم الصندوق' },
  ...
  'kisten.loeschen_titel': { de: '{code} löschen', ar: 'حذف {code}' },
  'kisten.loeschen_text': {
    de: 'Die Kiste, ihr Inhalt, die Fotos und der Verlauf werden gelöscht. Das lässt sich nicht rückgängig machen.',
    ar: 'سيُحذف الصندوق ومحتوياته وصوره وسجله. لا يمكن التراجع عن ذلك.',
  },
  'kisten.geloescht': { de: 'Kiste gelöscht', ar: 'تم حذف الصندوق' },
}
