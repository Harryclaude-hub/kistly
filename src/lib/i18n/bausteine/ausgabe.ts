...
export const ausgabe: Woerterbuch = {
  ...
  'ausgabe.spalte_groesse': { de: 'Groesse', ar: 'الحجم' },
  ...
  'ausgabe.spalten_hinweis': {
    de: 'Tipp die Spalten an, die du brauchst. Die Vorschau aendert sich sofort.',
  ...
  'ausgabe.farben_hinweis': {
    de: 'Zimmerfarbe, Personenfarbe und eigene Markierung. Aus ergibt ein schlichtes Blatt, das auch in Schwarzweiss gut aussieht.',
  ...
  'ausgabe.zebra_immer': {
    de: 'Eine Zeile bleibt heller, die naechste dunkler. Das gilt immer, auch schlicht und auch mit eigenen Farben.',
  ...
  'ausgabe.qr_groesse': { de: 'Groesse des QR-Codes', ar: 'حجم رمز QR' },
  ...
  'ausgabe.mit_moebeln': { de: 'Moebel mitnehmen', ar: 'تضمين الأثاث' },
  ...
  'ausgabe.word_hinweis': {
    de: 'Oeffnet sich in Word und in LibreOffice und laesst sich dort weiterschreiben.',
    ar: 'يفتح في Word وفي LibreOffice ويمكن متابعة الكتابة فيه.',
  },
  'ausgabe.html': { de: 'HTML-Datei', ar: 'ملف HTML' },
  'ausgabe.html_hinweis': {
    de: 'Eine Datei zum Weitergeben. Sie oeffnet sich in jedem Browser und laesst sich von dort als PDF speichern.',
    ar: 'ملف للمشاركة. يفتح في أي متصفّح ويمكن حفظه منه كـ PDF.',
  },
  'ausgabe.csv': { de: 'Tabelle als CSV', ar: 'جدول CSV' },
  'ausgabe.csv_hinweis': {
    de: 'Fuer Excel und Google Tabellen.',
    ar: 'لبرنامج Excel وجداول Google.',
  },
  'ausgabe.etiketten_statt': {
    de: 'Einzelne Etiketten mit grossem QR-Code gibt es im Etikettenbereich.',
